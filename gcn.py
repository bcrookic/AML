def load_data(data_dir, start_ts, end_ts):
	...
	features_csv = 'new_features.csv'   # new_features
...
torch.save(gcn.state_dict(), str(os.path.join("./data", "gcn_weights.pth")))
...
gcn = GCN_2layer(num_features, num_hiddens, num_classes)
gcn.load_state_dict(torch.load(os.path.join("./data", "gcn_weights.pth")))
